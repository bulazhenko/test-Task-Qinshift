...
public class LoginTests extends BaseTest {
    ...
    private static final boolean PRESS_ENTER_KEY = true; // Added for clarity
    ...
    @Test(dataProvider = "loginCredentials", description = "Verify user login")
    ...
    @Test(dataProvider = "loginCredentials", description = "Verify user login by pressing Enter key")
    ...
    @Test(description = "Verify user logout", priority = 5)
